// This file is a direct copy of the frontend `lib/technologyData.ts` to use its logic on the server.
  ...
  Farming: [
    {
      ...
      requiredTroops: 5,
      prerequisites: [],
      effects: [{ type: 'PASSIVE_FOOD_GENERATION', value: 10 }],
      icon: '🌱',
    },
    {
      id: 'crop-rotation',
      ...
      effects: [{ type: 'PASSIVE_FOOD_GENERATION', value: 15 }],
      icon: '🌾',
    },
    {
      id: 'hydroponics',
      ...
      effects: [{ type: 'PASSIVE_FOOD_GENERATION', value: 25 }],
      icon: '💡',
    },
  ],
  Scavenging: [
    {
      ...
      prerequisites: [],
      effects: [
        { type: 'SCAVENGE_YIELD_BONUS', value: 0.1, resource: 'Food' },
        { type: 'SCAVENGE_YIELD_BONUS', value: 0.1, resource: 'Scrap' },
      ],
      icon: '🔍',
    },
    {
    ...
    },
    {
      ...
      effects: [{ type: 'SCAVENGE_YIELD_BONUS', value: 0.20, resource: 'Scrap' }],
      icon: '🗺️',
    },
  ],
  Attack: [
    {
      ...
      requiredTroops: 5,
      prerequisites: [],
      effects: [{ type: 'COMBAT_BONUS_ATTACK', value: 0.05 }],
      icon: '🔪',
    },
    {
      id: 'forged-blades',
      ...
      effects: [{ type: 'COMBAT_BONUS_ATTACK', value: 0.10 }],
      icon: '⚔️',
    },
    {
      id: 'composite-bows',
      ...
      effects: [{ type: 'COMBAT_BONUS_ATTACK', value: 0.15 }],
      icon: '🏹',
    },
  ],
  Defense: [
    {
      ...
      requiredTroops: 8,
      prerequisites: [],
      effects: [{ type: 'COMBAT_BONUS_DEFENSE', value: 0.05 }],
      icon: '🧱',
    },
    {
        id: 'watchtowers',
    ...
    },
    {
      ...
      effects: [{ type: 'COMBAT_BONUS_DEFENSE', value: 0.15 }],
      icon: '🏰',
    },
  ]
};
